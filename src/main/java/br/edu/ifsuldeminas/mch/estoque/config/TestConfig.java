package br.edu.ifsuldeminas.mch.estoque.config;
...
import br.edu.ifsuldeminas.mch.estoque.entities.Payment;
...
import br.edu.ifsuldeminas.mch.estoque.repositories.ProductRepository;
import br.edu.ifsuldeminas.mch.estoque.repositories.UserRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.PAID, "Rua das Graças, 123", u1);
		Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), OrderStatus.WAITING_PAYMENT, "Av. XV de Janeiro, 67", u2);
